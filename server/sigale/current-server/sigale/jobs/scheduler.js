 ...
 *
 *   2. sweepExpiredHolds — recycle abandoned reservations. A
 *      `pending_payment` purchase past its 24h `reservationExpiresAt`
 ...
 *
 * @returns {Promise<number>} purchases expired
 */
